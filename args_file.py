...
def get_args():
    ...
    argparser.add_argument("--duplicate", type=int, default=20, help = "Number of generated candidates")
    argparser.add_argument("--decoding", type=str, default='original')

    # Pre-trained diffusion model
    argparser.add_argument("--diffusion_model", type=str, default='38M')  # default='38M'
    ...
    # Reward setting
    argparser.add_argument("--metrics_name", type=str, required=True, # ym
                           help="ptm,plddt,tm,crmsd,drmsd,lddt,hydrophobic,hydrophilic,match_ss,surface_expose,symmetry,globularity,solubility,general_fitness,instability_index")
    ...
    argparser.add_argument("--resume_from_trajectory", action="store_true",
                           help="Resume from trajectory.txt file instead of checkpoint")
